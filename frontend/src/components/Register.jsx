        ...
        <div className="col-sm-12 col-12">
            <div className="row">
                <div className="col-sm-6 col-12">
                    <img src="register.jpg" className='img-fluid mt-3' alt="" />
                </div>
                <div className="col-sm-6 col-12">
                    <div className='border shadow rounded mt-3 p-4'>
                        <h1 className='text-center mt-3 mb-4'>Register<span className='text-warning'>Form#</span></h1>
                        <form onSubmit={handleSubmit(handleRegister)}>
                            ...
                            <select {...register('status')} className='form-control mb-3 shadow-none'>
                                <option value="Lead Status">Select Lead Status</option>
